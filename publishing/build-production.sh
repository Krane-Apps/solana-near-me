...
if [ $? -eq 0 ]; then
    ...
    cp app/build/outputs/apk/release/app-release.apk ../publishing/NearMe-v1.0.6-production.apk
echo "   ✅ APK copied to: publishing/NearMe-v1.0.6-production.apk"
    echo ""
    echo "🔍 APK Info:"
    ls -lh ../publishing/NearMe-v1.0.6-production.apk
else
